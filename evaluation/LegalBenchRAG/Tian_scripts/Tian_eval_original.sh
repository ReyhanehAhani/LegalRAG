...
python -m evaluation.LegalBenchRAG.eval_precision_recall \
    ...
    --embedding-provider huggingface \
    --embedding-model jhu-clsp/BERT-DPR-CLERC-ft \
    --trace-file logs/eval/original/lbr_rec_clerc.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60
...
python -m evaluation.LegalBenchRAG.eval_precision_recall \ 
    ...
    --embedding-provider huggingface \
    --embedding-model nlpaueb/legal-bert-base-uncased \
    --trace-file logs/eval/original/lbr_hier_legalbert.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60
...
python -m evaluation.LegalBenchRAG.eval_precision_recall \
    ...
    --embedding-provider huggingface \
    --embedding-model nlpaueb/legal-bert-base-uncased \
    --trace-file logs/eval/original/lbr_rec_legalbert.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60
...
python -m evaluation.LegalBenchRAG.eval_precision_recall \
    ...
    --embedding-provider sentence_transformers \
    --embedding-model axondendriteplus/Legal-Embed-bge-base-en-v1.5 \
    --trace-file logs/eval/original/lbr_hier_legal-embed-bge.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60
...
python -m evaluation.LegalBenchRAG.eval_precision_recall \
    ...
    --embedding-provider sentence_transformers \
    --embedding-model axondendriteplus/Legal-Embed-bge-base-en-v1.5 \
    --trace-file logs/eval/original/lbr_rec_legal-embed-bge.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60
...
python -m evaluation.LegalBenchRAG.eval_precision_recall \
    ...
    --embedding-provider sentence_transformers \
    --embedding-model Octen/Octen-Embedding-0.6B \
    --trace-file logs/eval/original/lbr_hier_octen.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60
...
python -m evaluation.LegalBenchRAG.eval_precision_recall \
    ...
    --embedding-provider sentence_transformers \
    --embedding-model Qwen/Qwen3-Embedding-0.6B \
    --trace-file logs/eval/original/lbr_hier_qwen3.jsonl \
    --benchmarks-dir data/LegalBenchRAG/benchmarks_50 \
    --ks 2 4 6 10 15 20 40 60